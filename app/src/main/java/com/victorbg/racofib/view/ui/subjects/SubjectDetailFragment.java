...
public class SubjectDetailFragment extends BaseFragment implements Injectable {
  ...
  public View onCreateView(
    ...
    if (!getSubject()) {
      Toast.makeText(
              getContext(), getString(R.string.error_retrieving_subject_data), Toast.LENGTH_SHORT)
          .show();
  ...
  private void populateViewPager(Subject subject) {
    ...
    SubjectPagerAdapter adapter =
        new SubjectPagerAdapter(getActivity().getSupportFragmentManager(), fragments);
