...
public class MainBottomBarRules {
    ...
    public static SparseArray<BottomBarNavigator.Rule> getMainActivityRules() {
        ...
        result.put(R.id.subjectsFragment,
                new BottomBarNavigator.Rule(BottomAppBar.FAB_ALIGNMENT_MODE_CENTER,
                        BottomBarNavigator.NAVIGATION_MODE_NAVIGATION,
                        R.menu.main_menu,
                        R.drawable.ic_add_black_24dp,
        ...
        result.put(R.id.gradesFragment,
                new BottomBarNavigator.Rule(BottomAppBar.FAB_ALIGNMENT_MODE_CENTER,
                        BottomBarNavigator.NAVIGATION_MODE_NAVIGATION,
                        R.menu.main_menu,
                        R.drawable.ic_add_black_24dp,
        ...
        result.put(R.id.allExamsFragment,
                new BottomBarNavigator.Rule(BottomAppBar.FAB_ALIGNMENT_MODE_CENTER,
        ...
        result.put(R.id.subjectDetailFragment,
                new BottomBarNavigator.Rule(BottomAppBar.FAB_ALIGNMENT_MODE_CENTER,
                        BottomBarNavigator.NAVIGATION_MODE_BACK,
                        R.menu.main_menu,
                        R.drawable.ic_add_black_24dp,
        ...
        result.put(R.id.noteDetailFragment,
                new BottomBarNavigator.Rule(BottomAppBar.FAB_ALIGNMENT_MODE_END,
                        BottomBarNavigator.NAVIGATION_MODE_BACK,
                        R.menu.main_menu,
