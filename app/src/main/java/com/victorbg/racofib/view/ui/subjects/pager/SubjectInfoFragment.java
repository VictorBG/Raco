...
public class SubjectInfoFragment extends BaseFragment {
  ...
  public View onCreateView(
    ...
    FragmentSubjectInfoBinding binding =
  ...
  private void populateTeachers() {
    ...
    for (SubjectTeacher teacher : subject.teachers) {
      ...
      teacherTextView.setTextAppearance(
          getContext(), R.style.TextAppearance_MaterialComponents_Subtitle1);

      StringBuilder teacherTextViewText = new StringBuilder();
      if (teacher.responsable) {
        teacherTextViewText.append(getContext().getString(R.string.coordinator));
      ...
      teacherTextViewText.append(" ");
      teacherTextViewText.append(getContext().getString(R.string.middle_dot));
      teacherTextViewText.append(" ");
