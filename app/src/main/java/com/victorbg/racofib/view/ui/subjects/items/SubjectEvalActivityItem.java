...
public class SubjectEvalActivityItem
    extends AbstractItem<SubjectEvalActivityItem, SubjectEvalActivityItem.ViewHolder> {
      ...
      if (item.subject.notInClassHours) {
        w +=
            Character.SPACE_SEPARATOR
                + item.context.getString(R.string.not_class_hours_subject_eval_item);
      }
      week.setText(w);
    }
