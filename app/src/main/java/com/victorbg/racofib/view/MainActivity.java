...
public class MainActivity extends BaseActivity implements HasSupportFragmentInjector {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    NavigationUI.setupWithNavController(
        bottomBarNavigator, Navigation.findNavController(this, R.id.contentContainer));
        ...
        .observe(
            ...
            user ->
                Optional.ofNullable(user)
                    .ifPresent(
                        u ->
                            glideRequests.loadImage(
                                bottomBarNavigator.getMenu().getItem(4), u.photoUrl)));

    mainActivityViewModel =
        ViewModelProviders.of(this, viewModelFactory).get(MainActivityViewModel.class);
  }
