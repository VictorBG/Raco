...
/**
 * This behavior is applied to both items {@link
 * com.google.android.material.bottomnavigation.BottomNavigationView} and {@link
 * FloatingActionButton} in order to set the anchor dynamically, that involves a different placement
 * of the snackbar when the {@link FloatingActionButton} is hidden or not.
 *
 * @param <V>
 */
