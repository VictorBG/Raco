...
public class ColorSettingsActivity extends BaseActivity
    implements Injectable, ColorPickerDialogListener {

  @Inject LoadSubjectsUseCase loadSubjectsUseCase;
  @Inject ChangeColorSubjectUseCase changeColorSubjectUseCase;
  ...
  private void setRecycler() {
    ...
    fastAdapter.withEventHook(
        new ClickEventHook<ColorSettingsItem>() {
          @Override
          public void onClick(
              @NotNull View v,
              int position,
              @NotNull FastAdapter<ColorSettingsItem> fastAdapter,
              @NotNull ColorSettingsItem item) {
