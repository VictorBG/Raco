...
public class LogoutUserUseCase extends UseCase<Void, Void> {
  ...
  /**
   * Logs out the user from the system deleting all the data from the databases and cleaning all the {@link Repository} to indicates that a new data
   * is going to be added and they have to fetch it independently of the current state of their cached data.
   *
   * @return null
   */
  @Override
