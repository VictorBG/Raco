...
public class CustomWorkerFactory extends WorkerFactory {
  ...
  private final Map<Class<? extends ListenableWorker>, Provider<ChildWorkerFactory>>
      workersFactories;

  @Inject
  public CustomWorkerFactory(
      Map<Class<? extends ListenableWorker>, Provider<ChildWorkerFactory>> workersFactories) {
  ...
  public ListenableWorker createWorker(
    ...
    Provider<ChildWorkerFactory> factoryProvider =
        CollectionsUtil.getWorkerFactoryProviderByKey(workersFactories, workerClassName);
