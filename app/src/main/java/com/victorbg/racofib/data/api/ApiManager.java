...
public class ApiManager {
     ...
     * <p>
     * It also has attached an interceptor to add the Bearer token automatically
     * and an {@link okhttp3.Authenticator} to refresh the token when needed.
     * <p>
     * It also adds the language to be retrieved as a header.
     *
     * @param prefManager
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .addInterceptor(chain -> {
                    if (chain.request().method().equals("GET")) {
                        ...
                        if (!skipHeader) {
                            requestBuilder.addHeader("Authorization", NetworkUtils.prepareToken(prefManager.getToken()));
                        }
